  ...
  return (
    ...
    >
      ...
      <g transform="translate(0, -4500)">
        ...
        <path
          style={{ fill: isValentines ? highlightColor : 'url(#main-logo-gradient)', stroke: 'black', strokeWidth: '240.12' }}
      ...
      <g>
        ...
        {/* 3D */}
        <text x="35500" y="2500" style={{ fill: isValentines ? highlightColor : 'url(#main-logo-gradient)' }} className="fnt-montserrat-alt-bold" fontSize="4000">
          3D
        </text>
