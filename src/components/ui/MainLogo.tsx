...
export const MainLogo = ({ className, variant = 'white' }: MainLogoProps) => {
  ...
  // Colores constantes
  const highlightColor = '#60EBD4'; // Turquesa constante
  ...
  return (
    ...
    >
      ...
      <g transform="translate(0, -4500)">
        ...
        />
        {/* Parte Derecha - Turquesa */}
        <path
          style={{ fill: highlightColor, stroke: 'black', strokeWidth: '240.12' }}
      ...
      <g>
        ...
        {/* 3D */}
        <text x="35500" y="2500" style={{ fill: highlightColor }} className="fnt-montserrat-alt-bold" fontSize="4000">
          3D
        </text>
