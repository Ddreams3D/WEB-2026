...
import { Home as HomeIcon, Users as UsersIcon, FileText as DocumentTextIcon, Settings as CogIcon, BarChart3 as ChartBarIcon, LogOut as ArrowLeftOnRectangleIcon, ShoppingBag as ShoppingBagIcon } from '@/lib/icons';
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      ...
      {/* Top Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-neutral-800 shadow-sm border-b border-neutral-200 dark:border-neutral-700">
            ...
            <div className="flex items-center space-x-4">
               ...
               <div className="flex items-center space-x-2">
                 ...
                 <button
                   ...
                   className="flex items-center px-3 py-1.5 text-sm font-medium text-neutral-700 dark:text-neutral-300 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 hover:text-neutral-900 dark:hover:text-white transition-colors duration-200"
                 >
