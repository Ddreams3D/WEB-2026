...
export function ServiceShowcase({ config, featuredProducts, isPreview = false }: ServiceShowcaseProps) {
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-4">
              <div className="space-y-4">
                  ...
                  <p className="text-lg max-w-xl font-light text-muted-foreground">
                      Una selección de nuestros mejores trabajos en {config.name.toLowerCase()}.
                  </p>
              </div>
