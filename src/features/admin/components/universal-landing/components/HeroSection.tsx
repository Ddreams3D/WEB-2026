...
import { LayoutTemplate, Type, MousePointerClick, Link as LinkIcon } from 'lucide-react';
...
export function HeroSection({ data, updateField, disableTextEditing = false }: HeroSectionProps) {
  const isService = data.type === 'service';
  const isTextReadOnly = disableTextEditing && isService;
