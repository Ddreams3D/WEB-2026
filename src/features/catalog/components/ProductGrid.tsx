    ...
    >
      <AnimatePresence mode="popLayout">
        {products.map((item) => (
          ...
          >
            <ProductItem item={item} showAddToCart={showAddToCart} customAction={customAction} viewMode={viewMode} />
          </motion.div>
        ))}
      </AnimatePresence>
    </motion.div>
...
// ProductList component removed or kept if needed, but we focus on ProductGrid
