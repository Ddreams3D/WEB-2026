                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    {items.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center space-x-4 p-4 border border-gray-200 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800/50"
                      >
                        {/* Imagen del producto */}
                        ...
                        <div className="flex items-center space-x-3">
                          <button
                            ...
                            className="p-1 rounded-full bg-gray-100 dark:bg-neutral-700 hover:bg-gray-200 dark:hover:bg-neutral-600 transition-colors"
                            disabled={isLoading}
                          >
              ...
              <div className="bg-surface dark:bg-neutral-800 rounded-lg shadow-soft border border-gray-100 dark:border-neutral-700 sticky top-8">
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full mt-6 bg-green-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 shadow-sm"
                  >
                  ...
                  <Link
                    href="/marketplace"
                    className="block w-full mt-3 text-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors"
                  >
                    Continuar Comprando
                  </Link>
                </div>
